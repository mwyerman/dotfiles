...
local function diagnostic_submode()
  local hydra = require("hydra")
  local hint = [[
_J_: next diagnostic   _K_: prev diagnostic
                _q_: quit
  ]]
  ...
  hydra({
    ...
    heads = {
      ...
      { "K", function() vim.diagnostic.goto_prev() end, desc = "prev diagnostic" },
      { "q", nil, { exit = true, nowait = true, desc = "quit" } },
    }
  })
end
